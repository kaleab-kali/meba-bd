        ...
        <div className="space-y-8 md:space-y-12">
          {compliments.map((compliment, index) => (
            <motion.div
              ...
              className="group"
            >
              <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-4 sm:p-6 md:p-8 border border-pink-200 hover:border-pink-400 transition-all duration-300 hover:shadow-xl max-w-full">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <p className={`text-base sm:text-lg md:text-xl font-medium leading-relaxed break-words whitespace-normal text-wrap max-w-full ${compliment.color}`}>
